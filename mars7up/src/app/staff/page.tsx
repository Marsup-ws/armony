...
<div className="pt-24 flex flex-col md:flex-row items-start justify-center p-6 gap-8">
  ...
  <div className="w-full md:w-1/3 flex flex-col justify-center items-center text-center md:text-left">
    <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl text-[#cc0000] tracking-widest red-glow mb-4">
      Le groupe Armony
    </h1>
    <p className="font-display text-[#cc0000] red-glow text-base sm:text-lg lg:text-xl max-w-md">
